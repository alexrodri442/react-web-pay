...
```es6
// index.ios.js
global.PaymentRequest = require('react-web-pay').PaymentRequest;
```
...
- [Stripe](https://github.com/garrettmac/react-web-pay/blob/master/packages/react-web-pay-addon-stripe)
- [Braintree](https://github.com/garrettmac/react-web-pay/blob/master/packages/react-web-pay-addon-braintree)

🚨 _Note: On Android, Payment Processors are enabled by default._

## API
### [PaymentRequest](https://github.com/garrettmac/react-web-pay/blob/master/cli/packages/react-web-pay/docs/PaymentRequest.md)
### [PaymentRequestUpdateEvent](https://github.com/garrettmac/react-web-pay/blob/master/cli/packages/react-web-pay/docs/PaymentRequestUpdateEvent.md)
### [PaymentResponse](https://github.com/garrettmac/react-web-pay/blob/master/cli/packages/react-web-pay/docs/PaymentResponse.md)
...
# License
Licensed under the MIT License, Copyright © 2017, [Garrett Mac](https://twitter.com/garrettmac).

See [LICENSE](https://github.com/garrettmac/react-web-pay/blob/master/LICENSE) for more information.
